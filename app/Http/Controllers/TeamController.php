...
class TeamController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('team.create',compact('title','users'  ));
    }
    ...
    public function edit($id,Request $request)
    {
        ...
        $team = Team::findOrfail($id);
        return view('team.edit',compact('title','team' ,'users' ) );
    }
    ...
    {
        $msg = Ajaxis::BtDeleting('Warning!!','Would you like to remove This?','/team/'. $id . '/delete');
